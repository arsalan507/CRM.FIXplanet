...
export default async function OrdersPage() {
  ...
  // Build query based on role - filter by workflow_status = 'Order' only
  // This excludes leads that have been invoiced (workflow_status = 'Invoiced')
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Leads that have been converted to orders
        </p>
      </div>
      <LeadsPageClient
        leads={(leads as Lead[]) || []}
